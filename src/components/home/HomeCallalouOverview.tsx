    ...
    <Section>
      <div className="space-y-6">
        ...
        <div className="max-w-3xl space-y-4 text-slate-600">
          <p>
            Callaloo Ventures serves as the credible, structured, investable entity — the umbrella brand that signals Caribbean roots without cliché. It evokes nourishment, home, warmth, and cultural identity.
          </p>
          <p>
